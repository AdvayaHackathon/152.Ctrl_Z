...
<?php include"header.php"; ?>
  <section class="place-hero">
    <img src="images/Tipu_Sultan_Palace_5.jpg" alt="Bangalore" />
  ...
  <div class="container">
    <div class="photos-section">
      ...
      <div class="photo-grid">
        <img src="images/Tipu_Sultan_Palace_1.jpg" alt="Street in Tokyo">
        <img src="images/Tipu_Sultan_Palace_2.jpg" alt="Burj Khalifa">
        <img src="images/Tipu_Sultan_Palace_3.jpg" alt="Colosseum">
        <img src="images/Tipu_Sultan_Palace_4.jpg" alt="Tokyo Skytree - Photo 4">
        <img src="images/Tipu_Sultan_Palace_5.jpg" alt="Greek Cliffs">
        <img src="images/Tipu_Sultan_Palace_6.jpg" alt="Coastal View">
      </div>
    </div>
      ...
      <div id="details" class="tab-content active">
        ...
        <div class="info-group">
          ...
          <div class="map-container" id="map">
            <iframe src="https://www.google.com/maps?q=1-1-2%20Oshiage,%20Sumida%20City,%20Tokyo%20131-0045,%20Japan&output=embed"></iframe>
          </div>
        </div>
        <div class="info-group">
